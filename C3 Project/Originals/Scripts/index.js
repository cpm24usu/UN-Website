        ...
        fetch('../JSON/index.json')
            ...
            .then(data => {
                ...
                function updateBackground() {
                    if (x.matches) { /* If the screen is less than 1440px wide */
                ...
                logo.appendChild(logoDisplay).setAttribute("id", "logoJS");
                ...
                /* Footer */
                const footer = this.getElementById("footer");
